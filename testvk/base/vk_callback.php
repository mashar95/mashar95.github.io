...
$secret_key = '2wz5qkgWGHm1bFVF8FTD'; // Защищенный ключ приложения ВК
		...
		case 'get_item':
			...
			if ($item == 'offAds') {	// наименование товара
				$response['response'] = array(
					'item_id' => 1,  // ID 1 товара
					'title' => 'Отключение рекламы', // Заголовок 1 товара
					'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/0%20(4).png', // Ссылка на иконку 1 товара
			...
			elseif ($item == '200Diamonds') {
				$response['response'] = array(
					'item_id' => 2,  // ID 2 товара
					'title' => '200 алмазов', // Заголовок 2 товара
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/1%20(4).png', // Ссылка на иконку 2 товара
			...
			elseif ($item == '500Diamonds') {
				$response['response'] = array(
					'item_id' => 3,  // ID 3 товара
					'title' => '500 алмазов', // Заголовок 3 товара
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/2%20(4).png', // Ссылка на иконку 3 товара
			...
			elseif ($item == '1500Diamonds') {
				$response['response'] = array(
					'item_id' => 4,  // ID 4 товара
					'title' => '1500 алмазов', // Заголовок 4 товара
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/7%20(1).png', // Ссылка на иконку 4 товара
		...
		case 'get_item_test':
			...
			if ($item == 'offAds') {
				$response['response'] = array(
					...
					'title' => 'Отключение рекламы (тестовый режим)', // Заголовок 1 тестового товара
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/0%20(4).png', // Ссылка на иконку 1 тестового товара
					'price' => 15 // Цена 1 тестового товара в голосах ВК
					);
				}
			...
			elseif ($item == '200Diamonds') {
				$response['response'] = array(
					...
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/1%20(4).png', // Ссылка на иконку 2 тестового товара
			...
			elseif ($item == '500Diamonds') {
				$response['response'] = array(
					...
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/2%20(4).png', // Ссылка на иконку 3 тестового товара
			...
			elseif ($item == '1500Diamonds') {
				$response['response'] = array(
					...
					'photo_url' => 'https://github.com/mashar95/mashar95.github.io/blob/main/vktest/base/7%20(1).png', // Ссылка на иконку 4 тестового товара
